...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url('assets/images/ak-favicon.png'); ?>" type="image/x-icon">
    <link rel="icon" href="<?= base_url('assets/images/ak-favicon.png'); ?>" type="image/x-icon">
