...
<section class="services-section-three style-two">
    <div class="pattern-layer-one" style="background-image: url(<?= base_url('assets/images/icons/icon-8.png'); ?>)"></div>
    <div class="pattern-layer-two" style="background-image: url(<?= base_url('assets/images/icons/icon-9.png'); ?>)"></div>
    <div class="pattern-layer-three" style="background-image: url(<?= base_url('assets/images/icons/icon-10.png'); ?>)"></div>
    <div class="auto-container">
            ...
            <div class="image-column col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column">
                    <div class="image wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <img src="<?= base_url('assets/images/resource/mission.png'); ?>" alt="" />
                    </div>
                </div>
            </div>
            <div class="content-column col-lg-6 col-md-12 col-sm-12">
...
<section class="steps-section" style="background-image: url(<?= base_url('assets/images/background/pattern-14.png'); ?>)">
    <div class="auto-container">
            ...
            <div class="image-column col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column">
                    <div class="image titlt" data-tilt data-tilt-max="3">
                        <img src="<?= base_url('assets/images/resource/skill.png'); ?>" alt="" />
                    </div>
                </div>
            </div>
        </div>
