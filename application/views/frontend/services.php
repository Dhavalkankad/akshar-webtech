        ...
        <div class="row clearfix">
            <div class="service-block-four col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    ...
                    <div class="icon-one" style="background-image: url(<?= base_url('assets/images/icons/icon-1.png'); ?>)"></div>
                    <div class="icon-two" style="background-image: url(<?= base_url('assets/images/icons/icon-2.png'); ?>)"></div>
        ...
        <div class="row clearfix">
            <div class="title-column col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column">
                    ...
                    <a href="about.html" class="theme-btn btn-style-three"><span class="txt">Start Now</span></a>
                </div>
            </div>
    ...
    <div class="auto-container">
        <div class="row clearfix">
            ...
            <div class="image-column col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column">
                    <div class="image titlt" data-tilt data-tilt-max="3">
                        <img src="<?= base_url('assets/images/resource/newsletter.png'); ?>" alt="" />
                    </div>
                </div>
            </div>
        </div>
